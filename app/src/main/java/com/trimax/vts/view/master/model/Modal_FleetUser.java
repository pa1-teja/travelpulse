...
public class Modal_FleetUser {
    ...
    @SerializedName("data")
    @Expose
    private ArrayList<spleetDetails> data = null;
    ...
    public ArrayList<spleetDetails> getData() {
        return data;
    }

    public void setData(ArrayList<spleetDetails> data) {
        this.data = data;
    }

    public class spleetDetails {
        ...
        @SerializedName("notification_userid")
        @Expose
