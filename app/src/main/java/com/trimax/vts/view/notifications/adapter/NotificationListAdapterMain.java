...
public class NotificationListAdapterMain extends BaseAdapter {
	ArrayList<Datum> result;
    Context context;
    private LayoutInflater inflater = null;
	Datum userAlertListResponse;
	SharedPreferences sharedpreference;


    public NotificationListAdapterMain(Context ctx, ArrayList<Datum> userAlertListResponse) {
