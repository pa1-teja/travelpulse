...
public class VehicleRunReportActivity extends AppCompatActivity implements PositionClickListener, DatePickerDialog.OnDateSetListener,
    ...
    String ReportType = "Summarized", ChartType = "D", ChartTypen = "";
    int SelectedMonth;
    int SelectedYear;
    int SelectMAxMonth;

    TextView clnFrmDate, xvehiclegroup, clnToDate, xvehicl, xalert, xreport;
    ...
    private String TAG = VehicleRunReportActivity.class.getSimpleName();
...
// create and show the alert dialog
        ...
        txtFromMonthValue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pd.setListener(VehicleRunReportActivity.this);
        ...
        chartValue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (reportValue.getText().toString().equalsIgnoreCase("Vehicle Details")) {
                    ...
                    if (ReportType.equalsIgnoreCase("Vehicle Detail")) {
...
// create and show the alert dialog
            ...
            public void onClick(View v) {
                ...
                if (chartValue.getText().toString().equalsIgnoreCase("Daily")) {
                    ...
                    if (FromDate == null || ToDate == null) {
                        ...
                        cc.CommonDialog(VehicleRunReportActivity.this, "notification_click", "", "Select From date and To date.", "Ok", "", false);

                    } else if (FromDate.compareTo(ToDate) > 0) {
                        cc.CommonDialog(VehicleRunReportActivity.this, "notification_click", "", "To Date should be after From Date", "Ok", "", false);
                        ...
                        if (vehicleValue.getText().toString().equalsIgnoreCase("")) {
                            ...
                            cc.CommonDialog(VehicleRunReportActivity.this, "notification_click", "", "Please Choose Vehicle", "Ok", "", false);
                        } else {
                            ...
                            if (VehicleCount == 0) {
                                ...
                                getAlertReport(user_type_id, id,
                                        NewFromDateString, NewToDateString,
                    ...
                    if (reportValue.getText().toString().equalsIgnoreCase("Summarized")) {
                        if (ChartType.equalsIgnoreCase("M")) {
                            if (txtFromMonthValue.getText().toString().equalsIgnoreCase("")) {
                                cc.CommonDialog(VehicleRunReportActivity.this, "notification_click", "", "Please Select Month", "Ok", "", false);
                        ...
                        if (VehicleCount == 0) {
                            cc.CommonDialog(VehicleRunReportActivity.this, "notification_click", "", "Please Select Vehicle", "Ok", "", false);
    ...
    public void getAlertReport(String usertype_id, final String user_id, final String fromdate,
        ...
        try {
            ...
            Log.d(TAG, "report_type: " + report_type);
            ...
            Call<ResponseBody> call = objRetrofitInterface.getVehicleRunReport(auth, apiKey, usertype_id, user_id, fromdate, todate,
                    report_type, chart_type, vehicle_group, vehicle);
                                ...
                                if (strStatus.trim().equals("success")) {
                                    try {
                                        if (strStatus != null) {
                                            ...
                                            new AlertDialog.Builder(VehicleRunReportActivity.this)
...
//            initializeCustomDialogForType();
    ...
    public void current_vehicle_status_dashboard_AllVehicle(String usertype_id, final String user_id) {
        try {
            Utils.showProgressDialog(VehicleRunReportActivity.this, "Please Wait");
...
//                                }
    ...
    private void setVehicleGroupHashmap() {
        ...
        vehicleGroupDialog = new ReportCustomDialog(VehicleRunReportActivity.this, Constants.IReport.VEHICLE_GROUP,
    ...
    private void setVehiclesHashmap() {
        ...
        vehiclesDialog = new ReportCustomDialog(VehicleRunReportActivity.this, Constants.IReport.VEHICLES,
    ...
    private void setAlertHashmap() {
        ...
        alertDialog = new ReportCustomDialog(VehicleRunReportActivity.this, Constants.IReport.ALERT,
                alertHashmap, this);
    }
...
//            monthPicker.setValue(localCalendar.get(Calendar.MONTH));
            ...
            yearPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
                ...
                public void onValueChange(NumberPicker numberPicker, int oldvalue, int newvalue) {
                   ...
                   // Toast.makeText(VehicleRunReportActivity.this, "old__" + oldvalue, Toast.LENGTH_SHORT).show();
                    //Toast.makeText(VehicleRunReportActivity.this, "new__" + newvalue, Toast.LENGTH_SHORT).show();
