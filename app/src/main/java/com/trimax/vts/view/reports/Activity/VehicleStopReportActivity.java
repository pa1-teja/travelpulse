...
public class VehicleStopReportActivity extends AppCompatActivity implements PositionClickListener,DatePickerDialog.OnDateSetListener, ClickListner, ReportCallback {
    Context context;
    ...
    String ReportType = "", ChartType = "D", ChartTypen = "";
    int SelectedMonth = 0,SelectedYear=0;
    TextView clnFrmDate, xvehiclegroup, clnToDate, xvehicl, xalert, xchart, xreport;
    ...
    private String TAG = VehicleStopReportActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        xreport = (TextView) findViewById(R.id.xreport);

        xvehiclegroup = (TextView) findViewById(R.id.xvehiclegroup);
        xalert.setTypeface(font_awesome);
        xchart.setTypeface(font_awesome);
        xreport.setTypeface(font_awesome);
...
*/
        ...
        xreport.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                chartValue.setText("");
            }
...
// create and show the alert dialog
        ...
        txtFromMonthValue.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                pd.setListener(VehicleStopReportActivity.this);
     ...
     /*   txtFromMonthValue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                MonthPickerDialog.Builder builder = new MonthPickerDialog.Builder(VehicleStopReportActivity.this, new MonthPickerDialog.OnDateSetListener() {
                    @Override
                    public void onDateSet(int selectedMonth, int selectedYear) {
                        Log.d("", "selectedMonth : " + selectedMonth + " selectedYear : " + selectedYear);
                        // int finalMonth=selectedMonth
                        //Toast.makeText(VehicleStopReportActivity.this, "Date set with month" + selectedMonth + " year " + selectedYear, Toast.LENGTH_SHORT).show();
                        txtFromMonthValue.setText(Constant.getMonth(selectedMonth + 1) + " " + selectedYear);
                ...
                builder.setActivatedMonth(SelectedMonth)
                        .setMinYear(1990)
                        .setActivatedYear(selectedDate.get(Calendar.YEAR))
                        .setMaxYear(selectedDate.get(Calendar.YEAR))
                        .setMinMonth(Calendar.JANUARY)
                        .setTitle("Select  Month")
                        .setMonthRange(Calendar.JANUARY, Calendar.DECEMBER)
                         .setMaxMonth(selectedDate.get(Calendar.MONTH))
...
// add OK and Cancel buttons
                                builder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        // user clicked OK
                                        chartValue.setText(ChartTypen);
                                        if (ChartTypen.equalsIgnoreCase("")) {
                                            chartValue.setText("Daily");
                                        }
                                        xreport.setVisibility(View.VISIBLE);
...
//                            getAlertReport(user_type_id, id, NewFromDateString, NewToDateString, reportValue.getText().toString(), ChartType, VehicleGroup, sharedpreferencenew.getString("AlertGroupWiseVehicle", ""));
                                getAlertReport(user_type_id, id, NewFromDateString,
                                        NewToDateString, ReportValue,
                                        ChartType, getSelectedVehicleGroupIds(),
                                        getSelectedVehicleIds());
                            }
                        }
                ...
                }/*else if (!isDiffernceIsOneWeek(FromDate, ToDate)) {
                    Toast.makeText(context, "Duration between From Date and To Date cannot be greater than 1 week", Toast.LENGTH_SHORT).show();
                } */
                else {
                    ...
                    if(reportValue.getText().toString().equalsIgnoreCase("Summarized")){
                        if(ChartType.equalsIgnoreCase("M")) {
                            if (txtFromMonthValue.getText().toString().equalsIgnoreCase("")) {
                                cc.CommonDialog(VehicleStopReportActivity.this, "notification_click", "", "Please Select Month", "Ok", "", false);
                   ...
                   /* getAlertReport(user_type_id, id, NewFromDateString,
                            NewToDateString, reportValue.getText().toString(),
                            ChartType, VehicleGroup, sharedpreferencenew.getString("AlertGroupWiseVehicle", ""));
*/
    ...
    public void getAlertReport(String usertype_id, final String user_id, final String fromdate, final String todate,
                               final String report_type, final String chart_type, final String vehicle_group,
        ...
        try {
            ...
            Call<ResponseBody> call = objRetrofitInterface.getVehicleStopReport(auth, apiKey, usertype_id, user_id, fromdate, todate, report_type, chart_type, vehicle_group, vehicle);
                                ...
                                if (strStatus.trim().equals("success")) {
                                    try {
                                        if (strStatus != null) {
                                            ...
                                            new AlertDialog.Builder(VehicleStopReportActivity.this)
                                    ...
                                    try {
                                        ...
                                        e.printStackTrace();
                                        //Added by Apeksha 2/1/2019
                                        try {
                                            String msg = myObject.optString("msg");
                                            Log.v("category msg: ", msg);
                                            new AlertDialog.Builder(context)
                                                    .setMessage(msg)
                                                    .setCancelable(false)
                                                    .setPositiveButton("ok", new DialogInterface.OnClickListener() {
                                            ...
                                            Log.e(VehicleStopReportActivity.class.getSimpleName(), e1.getMessage());
                                        }
                                    }
...
//            initializeCustomDialogForType();
    ...
    public void current_vehicle_status_dashboard_AllVehicle(String usertype_id, final String user_id) {
        try {
            Utils.showProgressDialog(VehicleStopReportActivity.this, "Please Wait");
...
//                                }
    ...
    private void setVehicleGroupHashmap() {
        ...
        vehicleGroupDialog = new ReportCustomDialog(VehicleStopReportActivity.this, Constants.IReport.VEHICLE_GROUP,
    ...
    private void setVehiclesHashmap() {
        ...
        vehiclesDialog = new ReportCustomDialog(VehicleStopReportActivity.this, Constants.IReport.VEHICLES,
    ...
    private void setAlertHashmap() {
        ...
        alertDialog = new ReportCustomDialog(VehicleStopReportActivity.this, Constants.IReport.ALERT,
                alertHashmap, this);
    }
...
//            monthPicker.setValue(localCalendar.get(Calendar.MONTH));
            ...
            yearPicker.setOnValueChangedListener(new NumberPicker.OnValueChangeListener() {
                ...
                public void onValueChange(NumberPicker numberPicker, int oldvalue, int newvalue) {
                    ...
                    //Toast.makeText(VehicleStopReportActivity.this, "old__" + oldvalue, Toast.LENGTH_SHORT).show();
                    //Toast.makeText(VehicleStopReportActivity.this, "new__" + newvalue, Toast.LENGTH_SHORT).show();
