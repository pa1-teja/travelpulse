...
public class AlertSummaryReportActivityNew extends AppCompatActivity implements ReportCallback, View.OnClickListener {

    private Context context;
    private Calendar selectedDate;
    private TextView clnFrmDate, xvehiclegroup, clnToDate, xvehicl, xalert;
    private EditText FromDatetxt, ToDatetxt, vehiclegroupValue, vehicleValue, alertValue;
    ...
    private SharedPreferences sharedpreferencenew;
    private ArrayList<NotificationPojo> arrayList_type;
    private ArrayList<VehiclePojo> arrayList_vehicle;
    private ArrayList<VehicleViewGroup> arrayList_vehicle_group;
    private MultiAutoCompleteTextView  autoTextViewCustomthree;

    private CommonClass cc;
    private String day1, year1, month1, Currentdate, fromDate;
    private ProgressBar progressbar_login;
    private EditText edtDepDate, edtReturnDate;
    ...
    private String TAG = AlertSummaryReportActivityNew.class.getSimpleName();
    ...
    public void onClick(View view) {
        ...
        if (view == viewReport) {
            ...
            String fromDateString = FromDatetxt.getText().toString();
            String toDateString = ToDatetxt.getText().toString();
    ...
    private void initilization() {
        SharedPreferences sharedpreference = getSharedPreferences(Constants.app_preference,
        ...
        TextInputLayout frmDateLay = (TextInputLayout) findViewById(R.id.dateLayID);
        TextInputLayout toDateLay = (TextInputLayout) findViewById(R.id.todateLayID);
        TextInputLayout frmtimeLay = (TextInputLayout) findViewById(R.id.timeLayID);
        TextInputLayout toTimeLay = (TextInputLayout) findViewById(R.id.toTimeLayID);
...
//        cl = (ClickListner) this;
    ...
    private void setListener() {
        xvehicl.setOnClickListener(this);
        xalert.setOnClickListener(this);
        xvehiclegroup.setOnClickListener(this);
        FromDatetxt.setOnClickListener(this);
        viewReport.setOnClickListener(this);
        alertValue.setOnClickListener(this);
        vehicleValue.setOnClickListener(this);
        vehiclegroupValue.setOnClickListener(this);
        clnToDate.setOnClickListener(this);
        clnFrmDate.setOnClickListener(this);
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vehicle_idle_summary_report_new);
...
//        clearStaticDataFromConstants();
    ...
    public void getAlertReport(String usertype_id, final String user_id, final String fromdate,
                               final String todate, final String vehicle_group, final String vehicle) {
        try {
            ...
            Call<ResponseBody> call = objRetrofitInterface.getGetAlertsummaryreport(auth, apiKey,
                    usertype_id, user_id, fromdate, todate,vehicle,vehicle_group );
                                ...
                                if (strStatus.trim().equals("success")) {
                                    try {
                                        if (strStatus != null) {
                                            ...
                                            new AlertDialog.Builder(AlertSummaryReportActivityNew.this)
                            ...
                            case 200:
                                ...
                                try {
                                    ...
                                    if (status.equalsIgnoreCase("success")) {
                                        ...
                                        Log.e(TAG, "Response jsonArray" + jsonArray.length());
...
//                                }
    ...
    private class AsyncTaskToObtainGroupWiseVehicleForDropDown extends AsyncTask<Void, Void, Void> {
        @Override
        protected void onPreExecute() {
        }
        ...
        if (data != null) {
            if (requestCode == 1) {
                ...
                if (extras.getString("return_date") != null && !extras.getString("return_date").isEmpty()) {
                    String strReturnDate = extras.getString("return_date");
                ...
                if (extras.getString("departure_date") != null && !extras.getString("departure_date").isEmpty()) {
                    String strDepartureDate = extras.getString("departure_date");
    ...
    public void current_vehicle_status_dashboard_AllVehicle(String usertype_id, final String user_id) {
        try {
            Utils.showProgressDialog(AlertSummaryReportActivityNew.this, "Please Wait");
...
//                                }
    ...
    private void setVehicleGroupHashmap() {
        ...
        vehicleGroupDialog = new ReportCustomDialog(AlertSummaryReportActivityNew.this, Constants.IReport.VEHICLE_GROUP,
    ...
    private void setVehiclesHashmap() {
        ...
        vehiclesDialog = new ReportCustomDialog(AlertSummaryReportActivityNew.this, Constants.IReport.VEHICLES,
    ...
    private void setAlertHashmap() {
        ...
        alertDialog = new ReportCustomDialog(AlertSummaryReportActivityNew.this, Constants.IReport.ALERT,
                alertHashmap, this);
    }
