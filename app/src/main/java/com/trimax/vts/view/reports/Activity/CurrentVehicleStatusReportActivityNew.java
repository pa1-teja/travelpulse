...
public class CurrentVehicleStatusReportActivityNew extends AppCompatActivity implements PositionClickListener,
    ...
    private String TAG = CurrentVehicleStatusReportActivityNew.class.getSimpleName();
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_current_vehicle_status_report_new);
        context = this;
        ...
        viewReport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (vehicleValue.getText().toString().equalsIgnoreCase("")) {
                    ...
                    if (VehicleCount == 0) {
                        commonClass.CommonDialog(context, "notification_click", "", "Please Choose Vehicle", "Ok", "", false);
                    } else if(vehicleValue.getText().toString().equalsIgnoreCase("Please Select Vehicle")){
                        commonClass.CommonDialog(context, "notification_click", "", "Please Select Vehicle", "Ok", "", false);
                    }
                    else {
//                        getAlertReport(user_type_id, id, VehicleGroup,
// sharedpreferencenew.getString("AlertGroupWiseVehicle", ""), alertValue.getText().toString());
                        ...
                        //viewReport.setBackground(R.color.gray_color);
    ...
    public void getAlertReport(String usertype_id, final String user_id,
                               final String vehicle_group, final String vehicle, final String status) {
        try {
            ...
            Call<ResponseBody> call = objRetrofitInterface.GetVehiclestatusreport(auth, apiKey, usertype_id, user_id, vehicle_group, vehicle, status);
                    ...
                    try {
                        ...
                        switch (strResponceCode) {
                            case 200:
                                ...
                                Log.e(" Res CurrentStatus", strResponse);
                                ...
                                if (strStatus.trim().equals("success")) {
                                    try {
                                        if (strStatus != null) {
                                            ...
                                            new AlertDialog.Builder(CurrentVehicleStatusReportActivityNew.this)
...
//                        }
    ...
    public void current_vehicle_status_dashboard_AllVehicle(String usertype_id, final String user_id) {
        try {
            Utils.showProgressDialog(CurrentVehicleStatusReportActivityNew.this, "Please Wait");
                                            ...
                                            if (status.equalsIgnoreCase("success")) {
                                                ...
                                                for (int i = 0; i < jarray.length(); i++) {
                                                  ...
                                                  /*  if (Constant.arraylist_position_t.contains(i)) {
                                                    ...
                                                    notificatiobPojo.setTitle(jarray.getString(i));
...
//            initializeCustomDialogForBusStops();
    ...
    private void setVehicleGroupHashmap() {
        ...
        vehicleGroupDialog = new ReportCustomDialog(CurrentVehicleStatusReportActivityNew.this, Constants.IReport.VEHICLE_GROUP,
    ...
    private void setVehiclesHashmap() {
        ...
        vehiclesDialog = new ReportCustomDialog(CurrentVehicleStatusReportActivityNew.this, Constants.IReport.VEHICLES,
                vehiclesHashmap, this);
    }

    private void setAlertHashmap() {
        for (int i = 0; i < arrayList_type.size(); i++) {
            alertHashmap.put(arrayList_type.get(i).getTitle(), true);
        }
        Log.d(TAG, "setAlertHashmap: alertHashmap size: " + alertHashmap.size()
                + " arrayListsize: " + arrayList_type.size());

        alertDialog = new ReportCustomDialog(CurrentVehicleStatusReportActivityNew.this, Constants.IReport.ALERT,
                alertHashmap, this);
    }
    ...
    private void updateVehicleGroupHashmap(String selection) {
        ...
        vehicleValue.setText("" + "0" + " Vehicle Selected");
