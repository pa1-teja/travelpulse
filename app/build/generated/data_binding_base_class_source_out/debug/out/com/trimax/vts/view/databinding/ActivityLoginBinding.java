...
public abstract class ActivityLoginBinding extends ViewDataBinding {
  ...
  @NonNull
  public final CheckBox cbAutoVerification;
  ...
  @NonNull
  public final TextInputEditText tieOtp;
  ...
  protected ActivityLoginBinding(Object _bindingComponent, View _root, int _localFieldCount,
      MaterialButton btnLogin, CheckBox cbAutoVerification, ImageView ivLogo,
      ProgressBar pbProgress, TextInputEditText tieMobile, TextInputEditText tieOtp,
      TextInputLayout tilMobile, TextInputLayout tilVerificationCode, TextView tvGetCode) {
    super(_bindingComponent, _root, _localFieldCount);
    this.btnLogin = btnLogin;
    this.cbAutoVerification = cbAutoVerification;
    this.ivLogo = ivLogo;
    this.pbProgress = pbProgress;
    this.tieMobile = tieMobile;
    this.tieOtp = tieOtp;
    this.tilMobile = tilMobile;
    this.tilVerificationCode = tilVerificationCode;
